 ...
 *
 * @return {Composition} The `Composition` instance.
 */
...
Composition.prototype.addInstance = function (cInstance, isServer) {
    ...
    cInstance = self.addModuleFlow(Ul.clone(cInstance))
    cNode = self.addNode(cInstance, isServer);
    info = Object(self.appService.e)[cNode.name];
