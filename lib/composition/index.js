...
Composition.prototype.connect = function (s, t, a) {
                ...
                IterateObject(elm, function (comp, compIndex, comps) {
                    ...
                    switch (comp.type) {
                        ...
                        case Enny.TYPES.link:
                            if (comp.type === Enny.TYPES.link || comp.type === Enny.TYPES.streamHandler) {
                            ...
                            if (handlers.data.length || handlers.error.length) {
                                ...
                                if (Enny.TYPES(comp.type, Enny.TYPES.emit)) {
                                    console.warn("Input streams not currently supported for emits.");
                                    addInputStreams();
                                } else {
                                    addInputStreams();
                                }
...
Composition.Parsers = require("./parsers");
